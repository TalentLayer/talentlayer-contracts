...
contract TalentLayerService is Initializable, ERC2771RecipientUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function _validateService(
        ...
        bytes32 messageHash = keccak256(abi.encodePacked("createService", _profileId, nonce[_profileId]));
    ...
    function _validateProposal(
        ...
        bytes32 messageHash = keccak256(abi.encodePacked("createProposal", _profileId, _serviceId));
        _validatePlatformSignature(_signature, messageHash, _platformId);
    }
    ...
    function _validatePlatformSignature(
        ...
        require(talentLayerPlatformIdContract.ids(signer) == _platformId);
    }
