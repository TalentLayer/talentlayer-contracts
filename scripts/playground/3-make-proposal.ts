...
async function main() {
  ...
  await serviceRegistry.connect(bob).createProposal(serviceId, rateTokenBob, 10000000000000, bobUri)
  ...
  await serviceRegistry.connect(carol).createProposal(serviceId, rateTokenCarol, 20000000000000, carolUri)
}
